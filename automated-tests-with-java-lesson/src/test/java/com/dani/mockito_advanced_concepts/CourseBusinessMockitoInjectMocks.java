...
import com.dani.mockito_first_steps.business.CourseBusiness;
import com.dani.mockito_first_steps.service.CourseService;

@ExtendWith(MockitoExtension.class)
public class CourseBusinessMockitoInjectMocks {

        @Mock // cria um mock da interface CourseService
        CourseService mockService;

        @InjectMocks // cria uma instância da classe CourseBusiness e injeta o mock criado acima
        CourseBusiness business;

        List<String> courses;

        @Captor // cria uma instância de ArgumentCaptor
